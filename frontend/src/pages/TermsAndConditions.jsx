export default function TermsAndConditions() {
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in-up pb-20 font-tech relative">
      ...
      <div className="bg-zinc-950/80 backdrop-blur-xl rounded-2xl border border-purple-900/50 p-8 shadow-[0_0_30px_rgba(168,85,247,0.05)] space-y-8 text-zinc-400 font-mono text-xs leading-relaxed relative z-10">
        <section>
          <h2 className="text-sm font-bold text-purple-400 mb-4 tracking-widest uppercase border-b border-purple-900/30 pb-2">1. AGREEMENT_TO_TERMS</h2>
        ...
        <section>
          <h2 className="text-sm font-bold text-purple-400 mb-4 tracking-widest uppercase border-b border-purple-900/30 pb-2">2. INTELLECTUAL_PROPERTY_RIGHTS</h2>
        ...
        <section>
          <h2 className="text-sm font-bold text-purple-400 mb-4 tracking-widest uppercase border-b border-purple-900/30 pb-2">3. USER_REPRESENTATIONS</h2>
        ...
        <section>
          <h2 className="text-sm font-bold text-purple-400 mb-4 tracking-widest uppercase border-b border-purple-900/30 pb-2">4. UPLOADED_CONTENT</h2>
        ...
        <section>
          <h2 className="text-sm font-bold text-purple-400 mb-4 tracking-widest uppercase border-b border-purple-900/30 pb-2">5. GOVERNING_LAW</h2>
        ...
        <section>
          <h2 className="text-sm font-bold text-purple-400 mb-4 tracking-widest uppercase border-b border-purple-900/30 pb-2">6. COMMUNICATION_LINK</h2>
          <p>If you have any questions or concerns regarding these terms, please contact us at: <a href="mailto:hello@isharankumar.com" className="text-purple-400 hover:text-purple-300 hover:underline transition-colors decoration-dotted underline-offset-4">hello@isharankumar.com</a></p>
        </section>
      </div>
    </div>
  );
